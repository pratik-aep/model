...
Usage:
    # For checkpoints with full metadata (feature_idx_map, scaler, feature_cols):
    python scripts/predict.py --model output/models/pinn_model.pt --lat -65.0 --lon 0.0
    # For training checkpoints (also contain metadata after fixes):
