...
cd "/Users/pratiksmac/Downloads/icccy/iceberg-drift"
...
visualization:
  ...
  save_format: [png]
EOF
echo "   ✅ Config created at config/settings.yaml"
...
echo ""
python3 scripts/train.py --config config/settings.yaml --model-type pinn --epochs 3 --device cpu 2>&1 | tee /tmp/training_output.log
