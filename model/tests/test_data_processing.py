...
class TestPreprocessing:
    ...
    @pytest.fixture
    def sample_wind_ds(self):
        """Create sample wind dataset."""
    ...
    @pytest.fixture
    def sample_current_ds(self):
        """Create sample current dataset."""
